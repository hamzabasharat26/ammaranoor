      ...
      <div >
        ...
        >
          ...
          <p className="cl-reveal mt-6 max-w-xl text-fg-dim">
            {site.availability}. Based in {site.location} — {site.relocation}.
          </p>

          <div className="cl-reveal mt-10 flex w-full max-w-xl flex-col items-stretch overflow-hidden rounded-xl border border-line bg-ink-2 sm:flex-row">
            ...
            >
              Email me
              <span className="size-1.5 rounded-full bg-live transition-transform group-hover:scale-150" />
            </a>
          </div>
